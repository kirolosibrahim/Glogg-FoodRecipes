...
class StartupBenchmarks {
    ...
    @Test
    fun startupTestBaselineProfiles() = scrollAndNavigate(CompilationMode.Partial(BaselineProfileMode.Require))



    private fun benchmark(compilationMode: CompilationMode) {
        rule.measureRepeated(
            packageName = "com.kit.foodrecipes",
...
val list = device.findObject(By.res("item_list"))
    ...
    device.findObject(By.text("Vegetarian")).click()

    device.wait(Until.hasObject(By.text("Vegetarian")), 5000)
}